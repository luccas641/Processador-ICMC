...
;	4) Ja' terminou??? Cumpriu o que tinha que fazer??? O PC esta' pronto para a proxima instrucao (cuidado com Load, Loadn, Store, Jmp, Call)
	...
	add r3, r1, r2
	loadn r0, #10
	out r3, r0		; Printa F na linha 10
	...
	sub r3, r1, r2
	loadn r0, #12
	out r3, r0		; Printa G na linha 12
	...
	add r3, r4, r3
	loadn r0, #14
	out r3, r0		; Printa H na linha 14
	...
	add r3, r4, r3
	loadn r0, #16
	out r3, r0		; Printa I na linha 16
	...
	loadn r3, #'K'
	dec r3
	out r3, r0		; Printa J na linha 18
	...
	add r3, r4, r3
	loadn r0, #20
	out r3, r0		; Printa K na linha 20
	...
	add r3, r4, r3
	loadn r0, #22
	out r3, r0		; Printa L na linha 22
	...
	add r3, r4, r3
	loadn r0, #24
	out r3, r0		; Printa M na linha 24
	...
	cmp r1, r2
	jgr Maior
	out r3, r0		; Printa O na linha 26
	jmp SaiJMP
Maior:
	out r4, r0		; Printa N na linha 26
	jmp SaiJMP
...
SaiJMP:
	...
	jmp CallSai
CallMaior:
	out r3, r0		; Printa P na linha 28
	rts
CallMenorIgual:
	out r4, r0		; Printa Q na linha 28
	rts
...
CallSai:	
	...
	push r1
	pop r2
	out r2, r0		; Printa R na linha 30
